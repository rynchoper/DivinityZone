...
@register(outgoing=True, pattern="^.distrik$")
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("DISTRIK A NIH ")
        sleep(1)
        await e.edit("DATANG")
        sleep(1)
        await e.edit("BUAT")
        sleep(1)
        await e.edit("MEMBANTAI")
        sleep(1)
        await e.edit("ANAK")
        sleep(1)
        await e.edit("SOK JAGO")
        sleep(1)
        await e.edit("DI RP")
        sleep(1)
        await e.edit("GAUSA SOK JAGO DEH BELAGU")
        sleep(1)
        await e.edit("HAHAHA")
        await e.edit("PASANG MUKA DULU TOLOL")
        await e.edit("BESAR OMONGAN KECIL NYALI")
        await e.edit("DISTRICT A NI BOSS")
        sleep(1)
        await e.edit("GABAKAL MATI")
        sleep(1)
        await e.edit("DISTRICT A NI BOSS")
        sleep(1)
        await e.edit("GABAKAL GETER")
        sleep(1)
        await e.edit("PERGI JAUH SANA")
        sleep(1)
        await e.edit("DISTRICT A MAU LEWAT")
        sleep(1)
        await e.edit("JANGAN KETRIGER YA")
        sleep(1)
        await e.edit("DISTRICT A BARU DATENG")
        sleep(1)
